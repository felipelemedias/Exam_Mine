        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-[10px]">
            <div 
              ...
              onClick={() => handleNavigation(`/agent/${authState.isAuthenticated ? 'medication-prices' : 'medication-prices'}`)}
            >
              Buscar remédio
            </div>
            <Separator
            ...
            <div 
              className="font-['Open_Sans',Helvetica] text-[#565656] text-[16.9px] cursor-pointer hover:text-blue-600"
              onClick={() => handleNavigation(`/agent/${authState.isAuthenticated ? 'medication-info' : 'medication-info'}`)}
            >
              Consultar bula
            </div>
            <Separator
            ...
            <div 
              className="font-['Open_Sans',Helvetica] text-[#565656] text-[16.9px] cursor-pointer hover:text-blue-600"
              onClick={() => handleNavigation(`/agent/${authState.isAuthenticated ? 'general-question' : 'general-question'}`)}
            >
